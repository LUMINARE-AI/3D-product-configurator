        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute top-full left-0 mt-3 w-full bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-2 border-slate-700/50 rounded-xl shadow-2xl max-h-[480px] overflow-y-auto z-[101] backdrop-blur-md">
              <div className="p-3">
                <p className="px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider border-b border-slate-700/50">
                ...
                <div className="mt-2 space-y-2">
                  {allProducts.map((product) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-4 rounded-lg transition-all duration-200 flex items-center gap-4 ${
                        product._id === id
