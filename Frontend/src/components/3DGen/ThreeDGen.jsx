                ...
                <div className="w-full h-full flex flex-col p-4">
                  <div className="flex-1 flex items-center justify-center">
                    <div className="text-center">
                      <Sparkles className="w-20 h-20 mx-auto mb-4 text-green-500" />
                      <p className="text-lg font-semibold text-gray-800">Model Generated!</p>
                      <p className="text-sm text-gray-600 mt-2">Download your 3D model below</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 flex gap-3">
                    {generatedModel.model && (
                      <a
                        ...
                        className="flex-1 py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg text-center font-medium hover:shadow-lg hover:scale-105 transition-all"
                      >
                        Download GLB
                      </a>
                    )}
                    {generatedModel.pbr_model && generatedModel.pbr_model !== generatedModel.model && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 py-3 px-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg text-center font-medium hover:shadow-lg hover:scale-105 transition-all"
                      >
                        Download PBR
                      </a>
                    )}
